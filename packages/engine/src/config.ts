...
export const CONFIG = {
  ...
  /* ---- ГУМОВИЙ БЛОК ----
     ...
     13 клітинок/с при гравітації 29 — підйом ≈ 2.9 клітинки.

     Симетрично до стрибка наступні fallSec секунд кірка ПАДАЄ швидше:
     гравітація і стеля падіння множаться на fallBoost. */
  rubber: {
    kick: 13,
    fallBoost: 1.25,
    fallSec: 1.2,
...
export const BLOCKS: Record<BlockId, BlockDef> = {
  ...
  /* Гума — трамплін: посилений відскок і швидке падіння після нього.
     Ламається від дотику, як і решта одноразових блоків. */
  rubber:   { id: 'rubber',   name: 'Резина',    kind: 'rubber', tough: 1, cost: 1, value: 0,  color: '#d8489b' },
};
