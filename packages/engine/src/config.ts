...
export const CONFIG = {
  ...
  /* ---- ГУМОВИЙ БЛОК ----
     Відскок сильніший за звичайний на boost (і вгору, і вбік — разом зі
     стелею maxRise, інакше приріст просто зрізало б нею). Симетрично
     до цього наступні fallSec секунд кірка й ПАДАЄ швидше: гравітація
     та стеля падіння множаться на той самий boost. */
  rubber: {
    boost: 1.25,
    fallSec: 1.2,
  },
