...
export const CONFIG = {
  ...
  buy: {
    multBoost: 1.15,
    enchantBoost: 1.10,
    /* Заміряно sim/buy.ts (15k забігів на кірку). Пласка ціна для всіх
       не працює в принципі: за 10x дерев'яна кірка повертала б ~13%,
       а алмазна ~101% — перше грабунок, друге безкоштовні гроші.

       Числа не залежать від payoutK: він однаково ділить і виплату
       бонуски, і базовий RTP, тож відношення EV/RTP лишається тим
       самим. Переганяти sim/buy.ts треба після зміни HP/урону кірок,
       ваг блоків або самих бонусних множників. */
    price: {
      lvl2: 1.7,     // середня виплата x1.34
      lvl3: 4.4,     // x3.38
      lvl4: 8,       // x6.19
      gold: 12.5,    // x9.58
      diamond: 13.2, // x10.14
