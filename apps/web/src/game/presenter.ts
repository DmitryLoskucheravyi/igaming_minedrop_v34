...
/* ---- розмір кірки на полі ----
   ...
   упритул до країв -> 0.81, кірку зменшено в півтора раза.
   ...
   такої зміни обов'язковий новий прогін sim/final.ts. */
const PICK_VIS = 0.81;
...
/* Слід — силует самої кірки, тому їде за її розміром: 2.0 -> 1.33 і
   0.45 -> 0.30 разом зі зменшенням PICK_VIS у півтора раза. Лишити їх
   як були означало б, що позаду дрібної кірки тягнеться шлейф удвічі
   ширший за неї. */
const FX_TRAIL_SIZE = 1.33;
